...
class UserControllerApi
{
     ...
     * Fetch a user
     *
     * @param  string $jwtToken jwtToken (required)
     *
    ...
    {
        list($response) = $this->getUserUsingGETWithHttpInfo($jwtToken);
        return $response;
    }
     ...
     */
    public function getUserUsingGETAsync($jwtToken)
    {
        return $this->getUserUsingGETAsyncWithHttpInfo($jwtToken)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getUserUsingGETRequest($jwtToken)
    {
        // verify the required parameter 'jwtToken' is set
        if ($jwtToken === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $jwtToken when calling getUserUsingGET'
            );
        }
        ...
        // query params
        if ($jwtToken !== null) {
            $queryParams['jwtToken'] = ObjectSerializer::toQueryValue($jwtToken);
        }
