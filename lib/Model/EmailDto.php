...
class EmailDto implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['returnPath'] = isset($data['returnPath']) ? $data['returnPath'] : null;
    ...
    {
        return $this->container['returnPath'];
    }

    /**
     * Sets returnPath
     *
     * @param string $returnPath returnPath
     *
     * @return $this
     */
    public function setReturnPath($returnPath)
    {
        $this->container['returnPath'] = $returnPath;
